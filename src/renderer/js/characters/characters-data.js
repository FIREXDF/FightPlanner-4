// SSBU Characters Data
// Maps fighter folder names to character info
...
const SSBU_CHARACTERS = {
    ...
    'gamewatch': { name: 'Mr. Game & Watch', number: '26', series: 'Game & Watch' },
...
// Character images from Smash Bros Ultimate website
const CHARACTER_IMAGES = {
    // Original 8
    'mario': 'https://www.smashbros.com/assets_v2/img/fighter/mario/main.png',
    'donkey': 'https://www.smashbros.com/assets_v2/img/fighter/donkey_kong/main.png',
    ...
    'captain': 'https://www.smashbros.com/assets_v2/img/fighter/captain_falcon/main.png',
    ...
    'ice_climber': 'https://www.smashbros.com/assets_v2/img/fighter/ice_climbers/main.png',
    ...
    'younglink': 'https://www.smashbros.com/assets_v2/img/fighter/young_link/main.png',
    ...
    'gamewatch': 'https://www.smashbros.com/assets_v2/img/fighter/mr_game_and_watch/main.png',
    
    // Brawl newcomers
    'metaknight': 'https://www.smashbros.com/assets_v2/img/fighter/meta_knight/main.png',
    ...
    'szerosuit': 'https://www.smashbros.com/assets_v2/img/fighter/zero_suit_samus/main.png',
    ...
    'pzenigame': 'https://www.smashbros.com/assets_v2/img/fighter/squirtle/main.png',
    'pfushigisou': 'https://www.smashbros.com/assets_v2/img/fighter/ivysaur/main.png',
    'plizardon': 'https://www.smashbros.com/assets_v2/img/fighter/charizard/main.png',
    'ptrainer': 'https://www.smashbros.com/assets_v2/img/fighter/pokemon_trainer/main.png',
    ...
    'dedede': 'https://www.smashbros.com/assets_v2/img/fighter/king_dedede/main.png',
    ...
    'toonlink': 'https://www.smashbros.com/assets_v2/img/fighter/toon_link/main.png',
    ...
    'wiifit': 'https://www.smashbros.com/assets_v2/img/fighter/wii_fit_trainer/main.png',
    'rosetta': 'https://www.smashbros.com/assets_v2/img/fighter/rosalina_and_luma/main.png',
    'littlemac': 'https://www.smashbros.com/assets_v2/img/fighter/little_mac/main.png',
    'gekkouga': 'https://www.smashbros.com/assets_v2/img/fighter/greninja/main.png',
    'miifighter': 'https://www.smashbros.com/assets_v2/img/fighter/mii_brawler/main.png',
    'miiswordsman': 'https://www.smashbros.com/assets_v2/img/fighter/mii_swordfighter/main.png',
    'miigunner': 'https://www.smashbros.com/assets_v2/img/fighter/mii_gunner/main.png',
    ...
    'duckhunt': 'https://www.smashbros.com/assets_v2/img/fighter/duck_hunt/main.png',
    ...
    'gaogaen': 'https://www.smashbros.com/assets_v2/img/fighter/incineroar/main.png',
    'packun': 'https://www.smashbros.com/assets_v2/img/fighter/piranha_plant/main.png',
    ...
    'buddy': 'https://www.smashbros.com/assets_v2/img/fighter/banjo_and_kazooie/main.png',
...
// Common folder name aliases/variants used in mods
const FOLDER_ALIASES = {
    // Alternative names that mods might use
    'c_falcon': 'captain',
...
// Function to resolve folder name to canonical name
function resolveFolderName(folderName) {
    ...
    // Return as-is if it's already canonical or unknown
    return normalized;
}
